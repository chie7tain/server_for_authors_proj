...
// /authors
router.route("/createauthor").get(check_auth_1.checkAuth, controllers_1.createAuthorForm);
router.route("/authors").get(controllers_1.getAllData).post(check_auth_1.checkAuth, controllers_1.createData);
// /authors:
router
    .route("/authors/:id")
